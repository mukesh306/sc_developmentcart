...
global.io.on("connection", (socket) => {
  ...
  // ****************************
  // ⭐ YOUR FULL getExamTime EVENT ADDED HERE ⭐
  // ****************************
...
// MAIN CRON — RANK/RESULT AFTER FULL EXAM COMPLETED
setInterval(async () => {
  try {
    ...
    for (const [socketId, socket] of global.io.sockets.sockets) {
      ...
      for (const status of userExamStatuses) {
        ...
        // ⭐ FINAL FIX — Only show Rank when (1) this exam completed AND (2) full exam completed
